...
import "./Layout.scss";
import Operation from "./MainContent/Operation/Operation";
...
//  render() {
    ...
    //            component={Dashboard}
    //          />
    //          <Route exact path="/sales" component={SalePartners}/>
    //          <Route exact path="/account" component={Account} />
    //          <Route exact path="/news" component={News}/>
    //          <Route exact path="/operations" component={Operation} />
